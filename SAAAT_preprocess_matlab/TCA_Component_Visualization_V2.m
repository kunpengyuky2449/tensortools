function fig_output = TCA_Component_Visualization_V2(Session,rank,component,anomaly)
%
% Session = 'W3333_4';
% rank = 7;
% component = 6;
...
tensor_summary_folder = "D:\BCM_projects\TCA_project2\SAAAT_preprocess_matlab\tensor_perSession_v2";
...
save_folder = fullfile( ...
    'D:\BCM_projects\TCA_project2\SAAAT_preprocess_matlab\grabed_component_v2', ...
    Session);
...
tf_base_pupil = result_session.factors{a,3}( ...
     trial_mean_pupil < quantile(trial_mean_pupil,0.6) & ...
     trial_mean_pupil > quantile(trial_mean_pupil,0.3),j);
subplot(2,5,6)
...
ylabel('Trial Factor')
subplot(2,5,7)
scatter(trial_mean_pupil, result_session.factors{a,3}(:,j), '.')
...
xline(section_index(component),'r--')
xline(section_index(component+1),'r--')
hold off
